...
function carregarPerfil() {
  ...
  fetch("/usuarios/perfil/" + id)
    ...
    .then(function (dados) {
      ...
      document.getElementById("nascimento").value   = dados.dtNascimento ? dados.dtNascimento.split("T")[0] : "";
      ...
      preencherCard(dados.nome, dados.email, dados.dtNascimento ? dados.dtNascimento.split("T")[0] : null, dados.cidade);
      snapshot();
...
function saveProfile() {
  ...
  if (!logradouro) {
    setError("logradouro", "Logradouro é obrigatório.");
    valid = false;
  }

...
function editarPacote(id) {
    ...
    inputDataInicio.value = pacote.dataInicio ? pacote.dataInicio.split("T")[0] : "";
...
function publicarPacote() {
    ...
    var fkAgencia = sessionStorage.ID_AGENCIA;
    ...
    if (fkAgencia == null || fkAgencia == "") {
        alert("A data de início não pode estar vazia!")
        return;
    }

    console.log(nomePacote, categoria, destino, duracao, preco, descricao, vagas, dataInicio, fkAgencia);
